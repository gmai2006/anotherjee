...
public class HtmlGenerator {
	...
	public static void main(String[] args) {
		...
		String url = "http://127.0.0.1:8080/duhoc";
		...
		File[] files = folder.listFiles(new FileFilter() {
			...
			public boolean accept(File pathname) {
				...
				return pathname.isFile() && !pathname.getName().equals("layout.st");
			}
		});
	...
	private static void generateHTMLPage(String name, String extension,
...
//			compressor.setRemoveComments(true);  
			...
			compressedHtml = compressedHtml.replaceAll(".xhtml", ".html");
